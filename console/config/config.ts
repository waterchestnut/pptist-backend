...
export default defineConfig({
  ...
  openAPI: [
    {
      requestLibPath: 'import {ResponseStructure, pptonlineRequest as request} from \'@/services/request\';',
      schemaPath: 'http://localhost:12005/documentation/json',
      projectName: 'pptonline-base',
      mock: true,
      namespace: 'PPTONLINEAPI'
    },
  ],
  mfsu: {
    strategy: 'normal',
